...
def main():
    ...
    rows = [
        ...
        ('yonesato', '札幌市東米里・米里の物流地区', '用地探索',
         ...
         '豊平川等の洪水・内水と道路冠水を確認。',
         SOURCES['city_land_sale']),
        ('yamahana', '札幌市中央区 山鼻・南22条橋方面（参考）', '参考・公共用地の転用前提',
         'OSMの土地利用（半径2.5km、987区画）に民間の工業・遊休地はない。大区画は陸上自衛隊札幌駐屯地（12.5ha）、市電車両センター（約1ha）、藻岩浄水場、学校・大学・病院。成立するのは市有地・公共用地の転用か河川敷雪堆積場との一体整備を政策として扱う場合に限る。',
         '中央区南部・西部の雪を近距離で処理する仮説。市の配置案では中央区南地区の雪堆積場が五輪大橋・南22条橋の河川敷で、雪の流れと合う。円山より受電・IX・用地の条件が良いため参考地区を円山から山鼻に置き換えた。',
         '豊平川の洪水、住宅密集地への搬入、藻岩山側の斜面、公共施設の機能維持を確認。',
         SOURCES['snow_sites_plan']),
        ('miyanosawa', '札幌市西区 宮の沢・発寒木工団地南端', '用地探索',
         '発寒木工団地（17.8ha）まで1.9km、発寒鉄工団地（54.7ha）まで2.7kmで、工業地区の南西端に接する。駅周辺は住宅・商業が主で、まとまった遊休地は未確認。現行売地未確認。',
         '中央区西部・西区南部（円山・三角山側）の雪を受けるDC4の西側の受け口。新川・発寒北（DC4）は北区・手稲側に寄るため、同じ発寒工業地区の南端で運搬距離を比較する。',
         '琴似発寒川の洪水・内水、住宅地への搬入経路、既存工場との交錯を確認。',
         'https://hello.hepco.co.jp/map/?v=es'),
    ]
